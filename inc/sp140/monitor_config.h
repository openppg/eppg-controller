...
static const Thresholds bmsCellTempThresholds = {.warnLow = -10, .warnHigh = 45, .critLow = -15, .critHigh = 56};
static const Thresholds bmsHighCellVoltageThresholds = {.warnLow = 0.0, .warnHigh = 4.1, .critLow = 0.0, .critHigh = 4.2};
static const Thresholds bmsLowCellVoltageThresholds = {.warnLow = 3.3, .warnHigh = 5.0, .critLow = 3.1, .critHigh = 5.0};
...
static const Thresholds baroTempThresholds = {.warnLow = 0, .warnHigh = 50, .critLow = -10, .critHigh = 70};
