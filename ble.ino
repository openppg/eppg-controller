...
uint8_t t2cs_byte_array[16u] = {0x88,0x77,0xFB,0x19,0xE0,0x0B,0x40,0xBE,0x90,0x5E,0xAC,0xB4,0x2C,0x39,0xE6,0xB8}; 
/* Throttle value char UUID string: 5A57F691-C0B9-45DD-BDF1-279681212C29 */
uint8_t t2ctc_byte_array[16u] = {0x5A,0x57,0xF6,0x91,0xC0,0xB9,0x45,0xDD,0xBD,0xF1,0x27,0x96,0x81,0x21,0x2C,0x29}; 

BLEService        hrms = BLEService(t2cs_byte_array);
BLECharacteristic hrmc = BLECharacteristic(t2ctc_byte_array);
